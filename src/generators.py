...
#     print(f"\n {'*' * 10}\n")
#
#     # проверка функции card_number_generator
#     for card_number in card_number_generator(-1, 5):
#         print(card_number)
#         start_number = 0
#         end_number = 1
#         result = card_number_generator(start_number, end_number)
#         print(next(result))
#         print(next(result))
#
#         print(f'start={start_number}, end={end_number}, list={list(result)}, result={result} ')  # print(result)
#
#
#     print(f"\n {'*' * 10}\n")
